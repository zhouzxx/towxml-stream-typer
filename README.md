...
这里给大家写了一个uniapp和一个原生微信小程序的对话聊天使用示例,大家最好下载下来，模仿着写，里面的注释很详细，并有些最佳实践,如加载历史消息、滚动到底部、终止打印、停留页面终止自动滚动到底部、一键滚动到底部
...
| speed       | Number            | 每多少秒打印一个字符，值越小打印越快，单位是毫秒，默认 6 毫秒打印一个字符                                           |6|
